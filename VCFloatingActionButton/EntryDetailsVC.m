...
@interface EntryDetailsVC ()<floatMenuDelegate>{
...
- (void)viewDidLoad {
    ...
    CGRect floatFrame = CGRectMake([UIScreen mainScreen].bounds.size.width - 44 - 20, [UIScreen mainScreen].bounds.size.height - 88 - 20, 44, 44);
    
    addButton = [[VCFloatingActionButton alloc]initWithFrame:floatFrame normalImage:[UIImage imageNamed:@"plus_icon"] andPressedImage:[UIImage imageNamed:@"cross"] withScrollview:nil];
...
-(void)addBottomButton{
    ...
    [_scrlMain addSubview:_plusButtonsViewMain];
}
